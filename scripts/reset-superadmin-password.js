 ...
 * do sistema Khesef de forma segura via console.
 *
...
function printBanner() {
    ...
    print('║                                                            ║', 'cyan');
    print('║       Khesef - Sistema de Gestão Financeira            ║', 'cyan');
    print('║                                                            ║', 'cyan');
    print('╠════════════════════════════════════════════════════════════╣', 'cyan');
...
function questionPassword(rl, query) {
    return new Promise((resolve) => {
...
async function listSuperAdmins(client) {
...
async function main() {
    ...
    try {
        ...
        const newPassword = await questionPassword(createReadlineInterface(), `${colors.cyan}➤ Digite a nova senha: ${colors.reset}`);
        // Validar senha
        ...
        // Confirmar senha
        const confirmPassword = await questionPassword(createReadlineInterface(), `${colors.cyan}➤ Confirme a nova senha: ${colors.reset}`);
