...
const classificar_conta_pj_1 = require("../server/services/classificar-conta-pj");
const PLANO = [
...
for (const c of CASOS) {
    const r = (0, classificar_conta_pj_1.resolverContaPj)({
        contas: (_a = c.plano) !== null && _a !== void 0 ? _a : PLANO,
        tipo: c.tipo,
        contaInformada: c.contaInformada,
        descricao: c.descricao,
        segmento: c.segmento,
    });
    const obtido = (_c = (_b = r.conta) === null || _b === void 0 ? void 0 : _b.codigo) !== null && _c !== void 0 ? _c : "—";
    const ok = obtido === c.esperado;
    if (!ok)
        falhas++;
    console.log(`${ok ? "ok  " : "FALHA"} ${c.nome}`.padEnd(46), "|", c.esperado.padEnd(8), "|", obtido.padEnd(6), "|", r.motivo + (r.ignorouInformada ? " (ignorou palpite)" : ""));
}
