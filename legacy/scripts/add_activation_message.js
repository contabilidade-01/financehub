  ...
  try {
    ...
    const result = await client`
      INSERT INTO welcome_messages (
        ...
        'Olá {nome}! Temos uma ótima notícia: sua conta no Khesef foi ativada com sucesso! Agora você tem acesso completo a todos os recursos da plataforma. Aproveite para organizar suas finanças e alcançar seus objetivos financeiros.',
        'Olá {nome}!\n\nSua conta no Khesef foi ativada com sucesso!\n\nAgora você tem acesso completo a todos os nossos recursos:\n• Controle total de receitas e despesas\n• Relatórios detalhados\n• Metas financeiras\n• E muito mais!\n\nAcesse agora mesmo e comece a transformar sua vida financeira: https://app.controledinheiro.com.br\n\nQualquer dúvida, estamos à disposição.\n\nEquipe Khesef',
        true,
        true
