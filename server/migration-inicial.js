...
exports.runInitialMigration = runInitialMigration;
...
async function runInitialMigration({ dropAll = false } = {}) {
    ...
    publicPaths.forEach(publicPath => {
        const publicDir = path_1.default.resolve(process.cwd(), publicPath);
        const chartsDir = path_1.default.resolve(publicDir, 'charts');
        const reportsDir = path_1.default.resolve(publicDir, 'reports');
        ...
        [publicDir, chartsDir, reportsDir].forEach(dir => {
            if (!fs_1.default.existsSync(dir)) {
                ...
                fs_1.default.chmodSync(dir, 0o755);
...
if (isDirect) {
    (async () => {
        ...
        try {
            ...
            console.log(`🔐 Senha: ${'*'.repeat(((_a = url.password) === null || _a === void 0 ? void 0 : _a.length) || 0)}`);
        }
        catch (error) {
