...
async function getSetupStatus(req, res) {
    ...
    try {
        ...
        try {
            ...
            hasExistingData = parseInt(((_a = result[0]) === null || _a === void 0 ? void 0 : _a.count) || '0') > 0;
            await client.end();
        }
        catch (error) {
...
async function testDatabaseConnection(req, res) {
    ...
    try {
        ...
        // Testar conexão
        const client = (0, postgres_1.default)(databaseUrl, { prepare: false });
        try {
...
async function runSetup(req, res) {
    ...
    try {
        ...
        try {
            ...
            const [adminUser] = await db.insert(schema_js_1.users).values({
                nome: adminName,
                email: adminEmail,
            ...
            await db.insert(schema_js_1.wallets).values({
            ...
            for (const category of defaultCategories) {
                await db.insert(schema_js_1.categories).values(Object.assign(Object.assign({}, category), { global: true, usuario_id: null }));
            }
            ...
            for (const paymentMethod of defaultPaymentMethods) {
                await db.insert(schema_js_1.paymentMethods).values(Object.assign(Object.assign({}, paymentMethod), { usuario_id: null, ativo: true }));
            }
            // 7. Criar token API para o admin
            console.log('🔑 Criando token API...');
            const apiToken = generateApiToken();
            await db.insert(schema_js_1.apiTokens).values({
                usuario_id: adminUser.id,
                token: apiToken,
    ...
    try {
        ...
        try {
            ...
            res.json({
                ...
                adminId: (_a = inserted[0]) === null || _a === void 0 ? void 0 : _a.id
            });
        }
        catch (error) {
            await client.end();
