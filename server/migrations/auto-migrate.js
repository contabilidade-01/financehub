...
const STEPS = [
    {
        ...
        run: async () => {
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS compra_grupo VARCHAR(40)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS parcela_num INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS parcela_total INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_transacoes_compra_grupo ON transacoes(compra_grupo)`);
        },
    },
    {
    ...
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_metas_usuario_id ON metas_financeiras(usuario_id)`);
        },
    },
    {
        name: "empresas / empresas_contas / empresas_transacoes (PJ)",
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS tipo_pessoa VARCHAR(20) NOT NULL DEFAULT 'fisica'`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_empresas_transacoes_empresa ON empresas_transacoes(empresa_id)`);
            // Um login = uma empresa. Só cria o índice se não houver duplicatas.
            try {
                const dups = await db_1.db.execute((0, drizzle_orm_1.sql) `
        ...
        `);
                const lista = dups;
                if (lista.length > 0) {
                    console.warn(`[auto-migrate] idx_empresas_usuario_unico NÃO criado — duplicatas: ` +
          ...
          `);
                ...
                console.warn("[auto-migrate] idx_empresas_usuario_unico:", (e === null || e === void 0 ? void 0 : e.message) || e);
            }
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_ingestion_events_resultado ON ingestion_events(resultado)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_ingestion_events_data ON ingestion_events(data_criacao)`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_conversa_historico_user ON conversa_historico(usuario_id, id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE UNIQUE INDEX IF NOT EXISTS memoria_usuario_uq ON memoria_usuario(usuario_id, tipo, chave)`);
        },
    },
    {
      ...
      `);
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes_lixeira ADD COLUMN IF NOT EXISTS empresa_id INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_lixeira_carteira ON transacoes_lixeira(carteira_id, excluida_em)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_lixeira_empresa ON transacoes_lixeira(empresa_id, excluida_em)`);
        },
    },
    {
        ...
        run: async () => {
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS aprendizado_coletivo BOOLEAN NOT NULL DEFAULT true`);
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE UNIQUE INDEX IF NOT EXISTS memoria_global_uq ON memoria_global(escopo, chave)`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_whatsapp_onboarding_jid ON whatsapp_onboarding_states(remote_jid)`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_consent_usuario ON consentimentos_lgpd(usuario_id)`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_contas_banc_empresa ON contas_bancarias(empresa_id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_import_conta ON importacoes_extrato(conta_bancaria_id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE UNIQUE INDEX IF NOT EXISTS extrato_mov_fitid_uq ON extrato_movimentos(conta_bancaria_id, fitid) WHERE fitid IS NOT NULL`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_extrato_mov_import ON extrato_movimentos(importacao_id, status)`);
            // Ligações da transação PJ com a origem bancária
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS conta_bancaria_id INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS conciliado BOOLEAN NOT NULL DEFAULT false`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS fitid VARCHAR(120)`);
        },
    },
    {
    ...
    },
    {
        ...
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS ciclo_assinatura VARCHAR(12)`);
        },
    },
    {
        ...
        run: async () => {
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ALTER COLUMN status_assinatura SET DEFAULT 'sem_assinatura'`);
    ...
    },
    {
        ...
        run: async () => {
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE subscription_plans ADD COLUMN IF NOT EXISTS tipo_pessoa VARCHAR(20)`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_emp_cartoes_empresa ON empresas_cartoes(empresa_id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE UNIQUE INDEX IF NOT EXISTS emp_fatura_uq ON empresas_faturas(cartao_id, competencia)`);
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS movimenta_caixa BOOLEAN NOT NULL DEFAULT true`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS cartao_id INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS fatura_id INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS competencia VARCHAR(7)`);
        },
    },
    {
        name: "empresas_contas: grupo_gerencial + is_cmv (fluxo de caixa gerencial)",
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_contas ADD COLUMN IF NOT EXISTS grupo_gerencial VARCHAR(30)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_contas ADD COLUMN IF NOT EXISTS is_cmv BOOLEAN NOT NULL DEFAULT false`);
    ...
    },
    {
        ...
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE metas_financeiras ADD COLUMN IF NOT EXISTS empresa_id INTEGER REFERENCES empresas(id) ON DELETE CASCADE`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_metas_empresa_id ON metas_financeiras(empresa_id)`);
            // conta_id: liga um limite de despesa PJ a uma conta do plano de contas.
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE metas_financeiras ADD COLUMN IF NOT EXISTS conta_id INTEGER REFERENCES empresas_contas(id) ON DELETE SET NULL`);
    ...
    },
    {
        ...
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS reembolsavel BOOLEAN NOT NULL DEFAULT false`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_transacoes_reembolsavel ON transacoes(carteira_id, reembolsavel)`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_password_reset_tokens_hash ON password_reset_tokens(token_hash)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_password_reset_tokens_usuario ON password_reset_tokens(usuario_id)`);
        },
    },
    {
        ...
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS data_pagamento DATE`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_emp_formas_empresa ON empresas_formas_pagamento(empresa_id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `
    ...
    },
    {
        ...
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS reembolso_pessoal BOOLEAN NOT NULL DEFAULT false`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS data_vencimento DATE`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS itens_agrupados INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_emp_tx_reembolso ON empresas_transacoes(empresa_id, reembolso_pessoal, status)`);
        },
    },
    {
    ...
    },
    {
        ...
        run: async () => {
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ALTER COLUMN status_assinatura TYPE VARCHAR(50)`);
        },
    },
    {
    ...
    },
    {
        ...
        run: async () => {
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE contas_bancarias ALTER COLUMN empresa_id DROP NOT NULL`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE contas_bancarias ADD COLUMN IF NOT EXISTS nome VARCHAR(120)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE contas_bancarias ADD COLUMN IF NOT EXISTS cor VARCHAR(30)`);
            // Backfill nome a partir do banco quando ainda vazio.
            await db_1.db.execute((0, drizzle_orm_1.sql) `UPDATE contas_bancarias SET nome = banco WHERE nome IS NULL OR nome = ''`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_contas_banc_usuario ON contas_bancarias(usuario_id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS conta_bancaria_id INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS fatura_id INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS competencia VARCHAR(7)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE transacoes ADD COLUMN IF NOT EXISTS movimenta_caixa BOOLEAN NOT NULL DEFAULT true`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_transacoes_conta_banc ON transacoes(conta_bancaria_id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_transacoes_fatura ON transacoes(fatura_id)`);
        },
    },
    {
      ...
      `);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE UNIQUE INDEX IF NOT EXISTS fatura_pf_uq ON faturas(forma_pagamento_id, competencia)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_faturas_usuario ON faturas(usuario_id)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_faturas_carteira ON faturas(carteira_id)`);
        },
    },
    {
    ...
    },
    {
        ...
        run: async () => {
            const { migrarTxsCartaoGenericoPf } = await Promise.resolve().then(() => __importStar(require("../services/fatura-pf.service")));
            const r = await migrarTxsCartaoGenericoPf();
            if (r.txs > 0 || r.promovidos > 0 || r.anexadas > 0) {
                console.log(`[AutoMigrate] cartões PF → legado:${r.txs} txs/${r.usuarios} user(s), promovidos:${r.promovidos}, anexadas:${r.anexadas}`);
            }
        },
    },
    {
        ...
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS compra_grupo VARCHAR(40)`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS parcela_num INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE empresas_transacoes ADD COLUMN IF NOT EXISTS parcela_total INTEGER`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_emp_tx_compra_grupo ON empresas_transacoes(compra_grupo)`);
        },
    },
    {
        ...
        run: async () => {
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS exclusao_solicitada_em TIMESTAMPTZ`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS exclusao_efetiva_em TIMESTAMPTZ`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS exclusao_motivo TEXT`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS anonimizado_em TIMESTAMPTZ`);
            await db_1.db.execute((0, drizzle_orm_1.sql) `CREATE INDEX IF NOT EXISTS idx_usuarios_exclusao ON usuarios(exclusao_efetiva_em)`);
        },
    },
    {
        ...
        run: async () => {
            ...
            await db_1.db.execute((0, drizzle_orm_1.sql) `UPDATE contas_bancarias SET nome = banco WHERE empresa_id IS NOT NULL AND (nome IS NULL OR nome = '')`);
            const empresas = await db_1.db.execute((0, drizzle_orm_1.sql) `SELECT id, usuario_id FROM empresas WHERE COALESCE(ativo, true) = true`);
          ...
          LIMIT 1
        `);
                let caixaId = (_a = existentes[0]) === null || _a === void 0 ? void 0 : _a.id;
                if (!caixaId) {
                    const criada = await db_1.db.execute((0, drizzle_orm_1.sql) `
            INSERT INTO contas_bancarias (empresa_id, usuario_id, banco, nome, tipo, saldo_inicial, ativo)
            VALUES (${emp.id}, ${(_b = emp.usuario_id) !== null && _b !== void 0 ? _b : null}, 'Caixinha', 'Caixinha', 'caixa', 0, true)
            RETURNING id
          `);
                    caixaId = (_c = criada[0]) === null || _c === void 0 ? void 0 : _c.id;
                }
                else {
                    await db_1.db.execute((0, drizzle_orm_1.sql) `
    ...
    },
    {
      ...
      `);
          ...
          LIMIT 1
        `);
                let caixaId = (_a = caixa[0]) === null || _a === void 0 ? void 0 : _a.id;
                if (!caixaId) {
                    const criada = await db_1.db.execute((0, drizzle_orm_1.sql) `
            INSERT INTO contas_bancarias (empresa_id, usuario_id, banco, nome, tipo, saldo_inicial, ativo)
            VALUES (${emp.id}, ${(_b = emp.usuario_id) !== null && _b !== void 0 ? _b : null}, 'Caixinha', 'Caixinha', 'caixa', 0, true)
...
async function runAutoMigrations() {
    ...
    for (const step of STEPS) {
        try {
            ...
            console.error(`[AutoMigrate] passo falhou (seguindo): ${step.name}:`, err === null || err === void 0 ? void 0 : err.message);
        }
    }
