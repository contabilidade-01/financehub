...
exports.retryFailedPaymentsJob = retryFailedPaymentsJob;
const storage_1 = require("../storage");
const asaas_service_1 = require("../services/asaas.service");
async function retryFailedPaymentsJob() {
    console.log('[RetryJob] Starting failed payments check...');
    try {
        const asaasService = (0, asaas_service_1.getAsaasService)();
        // Buscar pagamentos vencidos com retry < 3
        const overduePayments = await storage_1.storage.getOverduePayments();
