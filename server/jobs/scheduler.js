...
exports.runRetryNow = runRetryNow;
// import cron from 'node-cron';
const sync_subscriptions_job_1 = require("./sync-subscriptions.job");
const retry_failed_payments_job_1 = require("./retry-failed-payments.job");
...
async function runSyncNow() {
    ...
    return await (0, sync_subscriptions_job_1.syncSubscriptionsJob)();
}
async function runRetryNow() {
    console.log('[Scheduler] Manual execution: retry payments');
    return await (0, retry_failed_payments_job_1.retryFailedPaymentsJob)();
}
